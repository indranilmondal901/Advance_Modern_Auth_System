...
export const ForgotPasswordContainer_Left = styled.div`
  position: absolute;
  top: 0;
  height: 100%;
  transition: all 0.6s ease-in-out;
  ...
  z-index: 2;
  text-align: center;
  background-image: url(${require("./Forgot_password.gif")});
  background-repeat: no-repeat;
  background-size: cover;
  background-position: center;
`;

export const ForgotPasswordContainer_Rigth = styled.div`
  position: absolute;
  top: 0;
  height: 100%;
  transition: all 0.6s ease-in-out;
